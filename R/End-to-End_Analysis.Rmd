...
ggplot(data = tcatch, mapping = aes(x = year, y = count)) +
  ...
  scale_y_continuous("Number of Animals Caught") +
  scale_color_manual(values = c("< 2m" = "#DE3C37", ">= 2m" = "#79668C", "Non Shark" = "#1E547D")) + #set the colors - chosen from the NatParks Volcanoes palette
  theme_classic() + #set the theme classic theme has x & y axis lines with no gridlines
    labs(title = "Marine Catchment by Length", #set the title
       subtitle = "Number of animals caught by length category within shark control areas", #set the subtitle, sits below the title to add additional information
